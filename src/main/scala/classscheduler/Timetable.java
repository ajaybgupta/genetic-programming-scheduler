...
public class Timetable {
    ...
    public Room getRandomRoom() {
        ...
        Room room = (Room) roomsArray[(int) (roomsArray.length * RandomNumberGenerator.get())];
        return room;
    }
    ...
    public Timeslot getRandomTimeslot() {
        ...
        Timeslot timeslot = (Timeslot) timeslotArray[(int) (timeslotArray.length * RandomNumberGenerator.get())];
        return timeslot;
    }
